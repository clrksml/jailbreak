...
function SelectMarker()
	...
	DButton1.Paint = function(self, width, height)
		...
		surface.DrawImage(DButton1:GetWide() / 2 - 29, 2, 58, 58, GAMEMODE.MarkerIcons[1].Mat)
	...
	DButton2.Paint = function(self, width, height)
		surface.DrawGradient(0, 0, width, height, 2, Color(245, 245, 245), Color(255, 255, 255))
		surface.DrawImage(DButton1:GetWide() / 2 - 29, 2, 58, 58, GAMEMODE.MarkerIcons[2].Mat)
	...
	DButton3.Paint = function(self, width, height)
		surface.DrawGradient(0, 0, width, height, 2, Color(245, 245, 245), Color(255, 255, 255))
		surface.DrawImage(DButton1:GetWide() / 2 - 29, 2, 58, 58, GAMEMODE.MarkerIcons[3].Mat)
	...
	DButton4.Paint = function(self, width, height)
		surface.DrawGradient(0, 0, width, height, 2, Color(245, 245, 245), Color(255, 255, 255))
		surface.DrawImage(DButton1:GetWide() / 2 - 29, 2, 58, 58, GAMEMODE.MarkerIcons[4].Mat)
